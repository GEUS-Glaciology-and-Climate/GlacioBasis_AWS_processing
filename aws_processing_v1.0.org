...
#+begin_example
  ...
  /tmp/ipykernel_25587/3890646725.py:39: DeprecationWarning: `np.float` is a deprecated alias for the builtin `float`. To silence this warning, use `float` by itself. Doing this will not modify any behavior and is safe. If you specifically wanted the numpy scalar type, use `np.float64` here.
  Deprecated in NumPy 1.20; for more details and guidance: https://numpy.org/devdocs/release/1.20.0-notes.html#deprecations
    if isinstance(df[c][v], np.float) and np.isnan(df[c][v]): continue
  /tmp/ipykernel_25587/3890646725.py:135: DeprecationWarning: `np.int` is a deprecated alias for the builtin `int`. To silence this warning, use `int` by itself. Doing this will not modify any behavior and is safe. When replacing `np.int`, you may wish to use e.g. `np.int64` or `np.int32` to specify the precision. If you wish to review your current use, check the release note link for additional information.
  Deprecated in NumPy 1.20; for more details and guidance: https://numpy.org/devdocs/release/1.20.0-notes.html#deprecations
    s = np.int(win_size/2)
  /tmp/ipykernel_25587/3890646725.py:137: FutureWarning: The frame.append method is deprecated and will be removed from pandas in a future version. Use pandas.concat instead.
  ...
  /tmp/ipykernel_25587/3890646725.py:137: FutureWarning: The frame.append method is deprecated and will be removed from pandas in a future version. Use pandas.concat instead.
    ds['tilt_x'] = (('time'), tdf.iloc[:s][::-1].append(tdf).append(tdf.iloc[-s:][::-1]).rolling(win_size, win_type='boxcar',     center=True).mean()[s:-s].values.flatten())
  /tmp/ipykernel_25587/3890646725.py:139: FutureWarning: The frame.append method is deprecated and will be removed from pandas in a future version. Use pandas.concat instead.
  ...
  /tmp/ipykernel_25587/3890646725.py:378: DeprecationWarning: `np.float` is a deprecated alias for the builtin `float`. To silence this warning, use `float` by itself. Doing this will not modify any behavior and is safe. If you specifically wanted the numpy scalar type, use `np.float64` here.
  Deprecated in NumPy 1.20; for more details and guidance: https://numpy.org/devdocs/release/1.20.0-notes.html#deprecations
    if isinstance(df[c][v], np.float) and np.isnan(df[c][v]): continue
  /tmp/ipykernel_25587/3890646725.py:474: DeprecationWarning: `np.int` is a deprecated alias for the builtin `int`. To silence this warning, use `int` by itself. Doing this will not modify any behavior and is safe. When replacing `np.int`, you may wish to use e.g. `np.int64` or `np.int32` to specify the precision. If you wish to review your current use, check the release note link for additional information.
  Deprecated in NumPy 1.20; for more details and guidance: https://numpy.org/devdocs/release/1.20.0-notes.html#deprecations
    s = np.int(win_size/2)
  /tmp/ipykernel_25587/3890646725.py:476: FutureWarning: The frame.append method is deprecated and will be removed from pandas in a future version. Use pandas.concat instead.
    ds['tilt_x'] = (('time'), tdf.iloc[:s][::-1].append(tdf).append(tdf.iloc[-s:][::-1]).rolling(win_size, win_type='boxcar',     center=True).mean()[s:-s].values.flatten())
  /tmp/ipykernel_25587/3890646725.py:476: FutureWarning: The frame.append method is deprecated and will be removed from pandas in a future version. Use pandas.concat instead.
    ds['tilt_x'] = (('time'), tdf.iloc[:s][::-1].append(tdf).append(tdf.iloc[-s:][::-1]).rolling(win_size, win_type='boxcar',     center=True).mean()[s:-s].values.flatten())
  /tmp/ipykernel_25587/3890646725.py:478: FutureWarning: The frame.append method is deprecated and will be removed from pandas in a future version. Use pandas.concat instead.
    ds['tilt_y'] = (('time'), tdf.iloc[:s][::-1].append(tdf).append(tdf.iloc[-s:][::-1]).rolling(win_size, win_type='boxcar',    center=True).mean()[s:-s].values.flatten())
  /tmp/ipykernel_25587/3890646725.py:478: FutureWarning: The frame.append method is deprecated and will be removed from pandas in a future version. Use pandas.concat instead.
    ds['tilt_y'] = (('time'), tdf.iloc[:s][::-1].append(tdf).append(tdf.iloc[-s:][::-1]).rolling(win_size, win_type='boxcar',    center=True).mean()[s:-s].values.flatten())
  ...
  /tmp/ipykernel_25587/3890646725.py:478: FutureWarning: The frame.append method is deprecated and will be removed from pandas in a future version. Use pandas.concat instead.
    ds['tilt_y'] = (('time'), tdf.iloc[:s][::-1].append(tdf).append(tdf.iloc[-s:][::-1]).rolling(win_size, win_type='boxcar',    center=True).mean()[s:-s].values.flatten())
  /tmp/ipykernel_25587/3890646725.py:572: RuntimeWarning: divide by zero encountered in true_divide
  ...
  /tmp/ipykernel_25587/3890646725.py:478: FutureWarning: The frame.append method is deprecated and will be removed from pandas in a future version. Use pandas.concat instead.
    ds['tilt_y'] = (('time'), tdf.iloc[:s][::-1].append(tdf).append(tdf.iloc[-s:][::-1]).rolling(win_size, win_type='boxcar',    center=True).mean()[s:-s].values.flatten())
  /tmp/ipykernel_25587/3890646725.py:572: RuntimeWarning: invalid value encountered in true_divide
    phi_sensor_rad = -np.pi/2-np.arctan(Y/X) # spherical coordinate
  ...
  /tmp/ipykernel_25587/3890646725.py:717: DeprecationWarning: `np.float` is a deprecated alias for the builtin `float`. To silence this warning, use `float` by itself. Doing this will not modify any behavior and is safe. If you specifically wanted the numpy scalar type, use `np.float64` here.
  Deprecated in NumPy 1.20; for more details and guidance: https://numpy.org/devdocs/release/1.20.0-notes.html#deprecations
    if isinstance(df[c][v], np.float) and np.isnan(df[c][v]): continue
  /tmp/ipykernel_25587/3890646725.py:813: DeprecationWarning: `np.int` is a deprecated alias for the builtin `int`. To silence this warning, use `int` by itself. Doing this will not modify any behavior and is safe. When replacing `np.int`, you may wish to use e.g. `np.int64` or `np.int32` to specify the precision. If you wish to review your current use, check the release note link for additional information.
  Deprecated in NumPy 1.20; for more details and guidance: https://numpy.org/devdocs/release/1.20.0-notes.html#deprecations
    s = np.int(win_size/2)
  /tmp/ipykernel_25587/3890646725.py:815: FutureWarning: The frame.append method is deprecated and will be removed from pandas in a future version. Use pandas.concat instead.
    ds['tilt_x'] = (('time'), tdf.iloc[:s][::-1].append(tdf).append(tdf.iloc[-s:][::-1]).rolling(win_size, win_type='boxcar',     center=True).mean()[s:-s].values.flatten())
  /tmp/ipykernel_25587/3890646725.py:815: FutureWarning: The frame.append method is deprecated and will be removed from pandas in a future version. Use pandas.concat instead.
    ds['tilt_x'] = (('time'), tdf.iloc[:s][::-1].append(tdf).append(tdf.iloc[-s:][::-1]).rolling(win_size, win_type='boxcar',     center=True).mean()[s:-s].values.flatten())
  /tmp/ipykernel_25587/3890646725.py:817: FutureWarning: The frame.append method is deprecated and will be removed from pandas in a future version. Use pandas.concat instead.
    ds['tilt_y'] = (('time'), tdf.iloc[:s][::-1].append(tdf).append(tdf.iloc[-s:][::-1]).rolling(win_size, win_type='boxcar',    center=True).mean()[s:-s].values.flatten())
  /tmp/ipykernel_25587/3890646725.py:817: FutureWarning: The frame.append method is deprecated and will be removed from pandas in a future version. Use pandas.concat instead.
    ds['tilt_y'] = (('time'), tdf.iloc[:s][::-1].append(tdf).append(tdf.iloc[-s:][::-1]).rolling(win_size, win_type='boxcar',    center=True).mean()[s:-s].values.flatten())
...
****** Radiation 
 ...
 #    ds['usr'] = ds['usr'].where(ds['usr'] != -9999.)
     ds = ds[['dsr_corr','usr_corr','dlr','ulr','albedo','cloud_cov', 't_surf']].to_dataframe()
 ...
 #+RESULTS:
 [[file:./.ob-jupyter/a015b142a03a574f193dcaee3aecfb6b73e1bf82.png]]
...
****** Radiation
 ...
 #+RESULTS:
 :RESULTS:
 [[file:./.ob-jupyter/e7034fdd40812db157c6c5d96fa88ea381e56e0b.png]]
 [[file:./.ob-jupyter/601202212315e051fe36abce3d97e601c53f930b.png]]
 :END:
...
z_l[:'2008-July-1'] = np.nan
z_l['2008'] = z_l['2008']-z_l['2008-July-2'].mean()
z_l['2009-10-1'] = np.nan
...
z_l['2011-1-1':'2011-5-7'] = np.nan
z_l['2011'] = z_l['2011']-z_l['2011-5-8'].mean()
z_l['2012-1-1':'2012-4-18'] = np.nan
z_l['2012'] = z_l['2012']-z_l['2012-4-19'].mean() 
...
z_l_hour.to_csv('data_v1.0/gem_database/2022/zac_l_hour_lowering.csv', index = True, float_format = '%g')
z_l_day.to_csv('data_v1.0/gem_database/2022/zac_l_day_lowering.csv', index = True, float_format = '%g')
#+END_SRC
...
****** Radiation
 ...
 #+RESULTS:
 :RESULTS:
 [[file:./.ob-jupyter/c277a3269f0d0b8f49ba0dcd51dbdb8cd4c074af.png]]
 [[file:./.ob-jupyter/74111f1057d247b4ec75cce9652a23a47fe40dd1.png]]
 :END:
...
<<load_libs>>
datapath = '/home/shl/OneDrive/projects/aws_processing_v1.0/data_v1.0/gem_database/2022/'
z_u = pd.read_csv(datapath+'preQC/zac_u_lowering.csv', parse_dates = True, index_col=0)



z_u['2017'] = z_u['2017']-z_u['2017-July-17':'2017-July-17'].mean()
z_u[:'2017-July-18'] = np.nan
z_u['2018'] = np.nan
z_u['2020'] = z_u['2020']-z_u['2020-June-15':'2020-June-22'].mean()
z_u['2020-January-1':'2020-June-15'] = np.nan
z_u['2020-August-12':'2020-December-31'] = np.nan

z_u['2021'] = z_u['2021']-z_u['2021-April-15':'2021-April-22'].mean()
z_u['2021-January-1':'2021-July-27'] = np.nan
z_u['2021-September-1':'2021-December-31'] = np.nan
...
z_u_hour.to_csv('data_v1.0/gem_database/2022/zac_u_hour_lowering.csv', index = True, float_format = '%g')
z_u_day.to_csv('data_v1.0/gem_database/2022/zac_u_day_lowering.csv', index = True, float_format = '%g')
#+END_SRC

#+RESULTS:
: /tmp/ipykernel_10803/1128106081.py:11: FutureWarning: Indexing a DataFrame with a datetimelike index using a single string to slice the rows, like `frame[string]`, is deprecated and will be removed in a future version. Use `frame.loc[string]` instead.
:   z_u['2017'] = z_u['2017']-z_u['2017-July-17':'2017-July-17'].mean()
: /tmp/ipykernel_10803/1128106081.py:13: FutureWarning: Indexing a DataFrame with a datetimelike index using a single string to slice the rows, like `frame[string]`, is deprecated and will be removed in a future version. Use `frame.loc[string]` instead.
:   z_u['2018'] = np.nan
: /tmp/ipykernel_10803/1128106081.py:14: FutureWarning: Indexing a DataFrame with a datetimelike index using a single string to slice the rows, like `frame[string]`, is deprecated and will be removed in a future version. Use `frame.loc[string]` instead.
:   z_u['2020'] = z_u['2020']-z_u['2020-June-15':'2020-June-22'].mean()
: /tmp/ipykernel_10803/1128106081.py:18: FutureWarning: Indexing a DataFrame with a datetimelike index using a single string to slice the rows, like `frame[string]`, is deprecated and will be removed in a future version. Use `frame.loc[string]` instead.
:   z_u['2021'] = z_u['2021']-z_u['2021-April-15':'2021-April-22'].mean()
...
*** Testing: Glaciological observations
...
#+BEGIN_SRC jupyter-python
 ...
 # image/png
 [[file:obipy-resources/9e526126f6e919503e0f2bfb2c43391732b7318e/ec7723be04b564ddac1a498c570caa8bbb988982.png]]
 :end:

There is really none of the data that I trust from zac_u....
#+BEGIN_SRC jupyter-python
 <<load_libs>>
 <<data_file_paths>>
 ...
 # image/png
 [[file:obipy-resources/9e526126f6e919503e0f2bfb2c43391732b7318e/d895742df8530e0ca16dffce316400fff45bea30.png]]
 :end:
...
# image/png
[[file:obipy-resources/9e526126f6e919503e0f2bfb2c43391732b7318e/2c0e2ee4edbfb9108ab2ed230310074a929945a8.png]]
:end:
...
[[file:./.ob-jupyter/3205d2eb47b9706997d30e5f2c3654e2ea3fdbe2.png]]
:END:
...
<<load_libs>>
datapath = '/home/shl/OneDrive/projects/aws_processing_v1.0/data_v1.0/gem_database/2022/'
z_l = pd.read_csv(datapath+'zac_l_hour_lowering.csv', parse_dates = True, index_col=0)
...
:RESULTS:
: <AxesSubplot: xlabel='time'>
[[file:./.ob-jupyter/34045f02a722f58a138c7eb8741e9f9c837fc8d5.png]]
:END:
...
merged.rename(columns = {'t_1':'T_air', 'rh': 'RH', 'p': 'P_air', 'dsr_corr':'SR_in', 'usr_corr':'SR_out', 'dlr':'LR_in', 'ulr':'LR_out','cloud_cov':'cloudcover','t_surf':'T_surf', 'wspd':'WS', 'z_boom':'H', 'z_pt_corr':'Z_pt' }, inplace = True)
...
:RESULTS:
#+begin_example
                          T_air       RH    P_air    SR_in   SR_out    LR_in  \
  time                                                                         
  ...
  ...                       ...      ...      ...      ...      ...      ...   
  2022-04-19 10:00:00 -12.12970  53.4731  909.600      NaN      NaN  212.059   
  2022-04-19 11:00:00 -11.02920  54.5762  909.379  345.706  277.579  221.505   
  2022-04-19 12:00:00 -10.76460  55.5457  909.050  367.490  296.479  240.777   
  2022-04-19 13:00:00  -9.78430  56.0870  908.870      NaN      NaN  237.073   
  2022-04-19 14:00:00  -8.39235  50.1146  908.599      NaN      NaN  231.321   

                        LR_out    albedo  cloudcover    T_surf       WS  \
  time                                                                    
  2008-03-29 18:00:00      NaN       NaN         NaN       NaN  3.06183   
  2008-03-29 19:00:00      NaN       NaN         NaN       NaN  1.73083   
  2008-03-29 20:00:00      NaN       NaN         NaN       NaN  2.68367   
  2008-03-29 21:00:00      NaN       NaN         NaN       NaN  3.08867   
  2008-03-29 22:00:00      NaN       NaN         NaN       NaN  4.31950   
  ...                      ...       ...         ...       ...      ...   
  2022-04-19 10:00:00  263.624  0.797619    0.463043 -11.65090      NaN   
  2022-04-19 11:00:00  265.081  0.805676    0.516157 -11.33500      NaN   
  2022-04-19 12:00:00  273.084  0.807218    0.706587  -9.48939      NaN   
  2022-04-19 13:00:00  280.150  0.803078    0.625535  -7.75355      NaN   
  2022-04-19 14:00:00  280.398  0.798091    0.505859  -7.63614      NaN   

                             H  Z_pt  
  time                                
  2008-03-29 18:00:00      NaN   NaN  
  2008-03-29 19:00:00      NaN   NaN  
  2008-03-29 20:00:00      NaN   NaN  
  2008-03-29 21:00:00      NaN   NaN  
  2008-03-29 22:00:00      NaN   NaN  
  ...                      ...   ...  
  2022-04-19 10:00:00  2.17570   NaN  
  2022-04-19 11:00:00  2.17573   NaN  
  2022-04-19 12:00:00  2.17417   NaN  
  2022-04-19 13:00:00  2.17322   NaN  
  2022-04-19 14:00:00  2.17596   NaN  

  [123213 rows x 13 columns]
#+end_example
[[file:./.ob-jupyter/9118417cba25f8bf46ff1745a9b078777e7587d2.png]]
:END:
...
merged.rename(columns = {'t_1':'T_air', 'rh': 'RH', 'p': 'P_air', 'dsr_corr':'SR_in', 'usr_corr':'SR_out', 'dlr':'LR_in', 'ulr':'LR_out','cloud_cov':'cloudcover','t_surf':'T_surf', 'wspd':'WS', 'z_boom':'H' }, inplace = True)
merged.plot(subplots = True, figsize = (12,12))
...
#+begin_example
  ...
  time                                                                     
  2009-05-15 20:00:00       NaN  38.3762      NaN    1.94761    0.873082   
  ...
  ...                       ...      ...      ...        ...         ...   
  2019-04-13 07:00:00 -2.603130  50.3367  843.031  133.29700         NaN   
  2019-04-13 08:00:00 -1.455170  53.7183  843.462  208.95600  207.027000   
  2019-04-13 09:00:00 -1.221730  54.2284  843.523  312.81000  303.702000   
  2019-04-13 10:00:00 -0.974421  56.0684  843.556        NaN         NaN   
  2019-04-13 11:00:00 -1.077870  55.6263  843.517        NaN         NaN   

                         LR_in   LR_out    albedo  cloudcover    T_surf  \
  time                                                                    
  2009-05-15 20:00:00  397.430  396.762       NaN    0.869447  16.07180   
  2009-05-15 21:00:00      NaN      NaN       NaN         NaN       NaN   
  2009-05-15 22:00:00      NaN      NaN       NaN         NaN       NaN   
  2009-05-15 23:00:00      NaN      NaN       NaN         NaN       NaN   
  2009-05-16 00:00:00      NaN      NaN       NaN         NaN       NaN   
  ...                      ...      ...       ...         ...       ...   
  2019-04-13 07:00:00  249.076  267.367       NaN    0.427362 -10.97330   
  2019-04-13 08:00:00  258.101  279.943       NaN    0.466625  -7.91416   
  2019-04-13 09:00:00  264.028  281.681       NaN    0.517423  -7.53442   
  2019-04-13 10:00:00  263.821  281.756  0.951206    0.503184  -7.51478   
  2019-04-13 11:00:00  251.199  283.532  0.885045    0.375824  -6.99982   

                            WS        H  
  time                                   
  2009-05-15 20:00:00  0.00000      NaN  
  2009-05-15 21:00:00      NaN      NaN  
  2009-05-15 22:00:00      NaN      NaN  
  2009-05-15 23:00:00      NaN      NaN  
  2009-05-16 00:00:00      NaN      NaN  
  ...                      ...      ...  
  2019-04-13 07:00:00  6.06417  2.18327  
  2019-04-13 08:00:00  8.00800  2.19128  
  2019-04-13 09:00:00  6.28483  2.19484  
  2019-04-13 10:00:00  4.95967  2.19339  
  2019-04-13 11:00:00  4.48017  2.19040  

  [86872 rows x 12 columns]
#+end_example
[[file:./.ob-jupyter/d514e248b4fe16e366df03fc342a8974852536ac.png]]
:END:
