...
#+BEGIN_SRC jupyter-python
 ...
 #+RESULTS:
 [[file:./.ob-jupyter/98762baf63a63923e11e7f438d7576e487025a1d.png]]
...
:RESULTS:
: <AxesSubplot: xlabel='time'>
[[file:./.ob-jupyter/9f2a5a488f3200b99903eca7bfa98924b52cd831.png]]
:END:
...
******** Creating the temporal datasets and write out netcdfs
    ...
    r.out.gdal in=demNE output=GRASS_files/aoi.tif --overwrite
...
#+RESULTS:
:RESULTS:
: <matplotlib.legend.Legend at 0x7f2766d25b20>
[[file:./.ob-jupyter/8c2d42b1246f403f6cbe9e8cb313b018487da0db.png]]
:END:
