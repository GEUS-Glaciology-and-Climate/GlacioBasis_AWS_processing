...
#temp_day.to_csv('data_v1.0/gem_database/2022/preQC/zac_a_day_temperature.csv', index = True, float_format = '%g')
  ...
  #+RESULTS: zac_a_preQC_temperature
  : None
...
#rh_day.to_csv('data_v1.0/gem_database/2022/preQC/zac_a_day_relative_humidity.csv', index = True, float_format = '%g')
 ...
 #+RESULTS: zac_a_preQC_relative_humidity
 : None
...
# wspd_day.to_csv('data_v1.0/gem_database/2022/preQC/zac_a_day_wind_speed.csv', index = True, float_format = '%g')
 ...
 #+RESULTS: zac_a_preQC_wind_speed
 : None
...
#z_day.to_csv('data_v1.0/gem_database/2022/preQC/zac_a_day_boom_height.csv', index = True, float_format = '%g')
 ...
 #+RESULTS: zac_a_preQC_boom_height
 : None
...
#z_day.to_csv('data_v1.0/gem_database/2022/preQC/zac_a_day_SR50_stake_height.csv', index = True, float_format = '%g')
 ...
 #+RESULTS: zac_a_preQC_stake_height
 : None
...
#temp_day.to_csv('data_v1.0/gem_database/2022/zac_a_day_temperature.csv', index = True, float_format = '%g')
 ...
 #+RESULTS: zac_a_postQC_temperature
 : None
...
# rad_day.to_csv('data_v1.0/gem_database/2022/zac_a_day_radiation.csv', index = True, float_format = '%g')
 ...
 #+RESULTS: zac_a_postQC_radiation
 : None
...
import matplotlib.pyplot as plt
site = 'zac_l'
df = pd.read_csv('/home/shl@geus.dk/OneDrive/projects/aws_processing_v1.0/data_v1.0/gem_database/2022/'+site+'_2008_2022_QC_final.csv')
print(df.keys())
#+END_SRC

#+RESULTS:
: Index(['time', 't_u', 'rh_u_corr', 'p_u', 'dsr', 'usr', 'dsr_corr', 'usr_corr',
:        'dlr', 'ulr', 'albedo', 'cloud_cover', 't_surf', 'I', 'wspd', 'z_boom',
:        'ice_ablation'],
:       dtype='object')
...
filename=/home/shl@geus.dk/OneDrive/projects/aws_processing_v1.0/data_v1.0/gem_database/2022/zac_l_2008_2022_QC_final
filestorage=/home/shl@geus.dk/OneDrive/projects/aws_processing_v1.0/data_v1.0/gem_database/2022/
neadfile=/home/shl@geus.dk/OneDrive/projects/aws_processing_v1.0/data_v1.0/gem_database/2022/zac_l_nead.csv

cp $filename.csv ${filename}_tmp.csv
sed -i '1d' ${filename}_tmp.csv
cat $neadfile ${filename}_tmp.csv > ${filestorage}ZAC_L.csv
...
#+BEGIN_SRC sh :session
filename=/home/shl@geus.dk/OneDrive/projects/aws_processing_v1.0/data_v1.0/gem_database/2022/zac_u_2008_2022_QC_final
filestorage=/home/shl@geus.dk/OneDrive/projects/aws_processing_v1.0/data_v1.0/gem_database/2022/
neadfile=/home/shl@geus.dk/OneDrive/projects/aws_processing_v1.0/data_v1.0/gem_database/2022/zac_u_nead.csv

cp $filename.csv ${filename}_tmp.csv
sed -i '1d' ${filename}_tmp.csv
cat $neadfile ${filename}_tmp.csv > ${filestorage}ZAC_U.csv
rm ${filename}_tmp.csv
...
#+BEGIN_SRC sh :session
filename=/home/shl@geus.dk/OneDrive/projects/aws_processing_v1.0/data_v1.0/gem_database/2022/zac_a_2008_2022_QC_final
filestorage=/home/shl@geus.dk/OneDrive/projects/aws_processing_v1.0/data_v1.0/gem_database/2022/
neadfile=/home/shl@geus.dk/OneDrive/projects/aws_processing_v1.0/data_v1.0/gem_database/2022/zac_a_nead.csv

cp $filename.csv ${filename}_tmp.csv
sed -i '1d' ${filename}_tmp.csv
cat $neadfile ${filename}_tmp.csv > ${filestorage}ZAC_A.csv
rm ${filename}_tmp.csv
...
columns = ['time', 't_u', 'rh_u_corr', 'p_u', 'dsr', 'usr', 'dsr_corr', 'usr_corr', 'dlr', 'ulr', 'albedo', 'cloud_cover', 't_surf', 'I', 'wspd', 'z_boom', 'ice_ablation']
df = pd.read_csv(filename, skiprows=16, names = columns, index_col = 0, parse_dates = True)
df.plot(subplots=True)
plt.show()
...
filename = '/home/shl@geus.dk/OneDrive/projects/aws_processing_v1.0/data_v1.0/gem_database/2022/ZAC_A.csv'
columns = ['time', 't_u', 'rh_u_corr', 'p_u', 'dsr', 'usr', 'dsr_corr', 'usr_corr', 'dlr', 'ulr', 'albedo', 'cloud_cover', 't_surf', 'I', 'wspd', 'z_boom']
df = pd.read_csv(filename, skiprows=16, names = columns, index_col = 0, parse_dates = True)
df.plot(subplots=True)
plt.show()
