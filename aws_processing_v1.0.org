...
#+begin_example
  ...
  /tmp/ipykernel_13595/1019137027.py:39: DeprecationWarning: `np.float` is a deprecated alias for the builtin `float`. To silence this warning, use `float` by itself. Doing this will not modify any behavior and is safe. If you specifically wanted the numpy scalar type, use `np.float64` here.
  Deprecated in NumPy 1.20; for more details and guidance: https://numpy.org/devdocs/release/1.20.0-notes.html#deprecations
    if isinstance(df[c][v], np.float) and np.isnan(df[c][v]): continue
  /tmp/ipykernel_13595/1019137027.py:136: DeprecationWarning: `np.int` is a deprecated alias for the builtin `int`. To silence this warning, use `int` by itself. Doing this will not modify any behavior and is safe. When replacing `np.int`, you may wish to use e.g. `np.int64` or `np.int32` to specify the precision. If you wish to review your current use, check the release note link for additional information.
  Deprecated in NumPy 1.20; for more details and guidance: https://numpy.org/devdocs/release/1.20.0-notes.html#deprecations
    s = np.int(win_size/2)
  /tmp/ipykernel_13595/1019137027.py:138: FutureWarning: The frame.append method is deprecated and will be removed from pandas in a future version. Use pandas.concat instead.
  ...
  /tmp/ipykernel_13595/1019137027.py:138: FutureWarning: The frame.append method is deprecated and will be removed from pandas in a future version. Use pandas.concat instead.
    ds['tilt_x'] = (('time'), tdf.iloc[:s][::-1].append(tdf).append(tdf.iloc[-s:][::-1]).rolling(win_size, win_type='boxcar',     center=True).mean()[s:-s].values.flatten())
  /tmp/ipykernel_13595/1019137027.py:140: FutureWarning: The frame.append method is deprecated and will be removed from pandas in a future version. Use pandas.concat instead.
  ...
  /tmp/ipykernel_13595/1019137027.py:390: DeprecationWarning: `np.float` is a deprecated alias for the builtin `float`. To silence this warning, use `float` by itself. Doing this will not modify any behavior and is safe. If you specifically wanted the numpy scalar type, use `np.float64` here.
  Deprecated in NumPy 1.20; for more details and guidance: https://numpy.org/devdocs/release/1.20.0-notes.html#deprecations
    if isinstance(df[c][v], np.float) and np.isnan(df[c][v]): continue
  /tmp/ipykernel_13595/1019137027.py:487: DeprecationWarning: `np.int` is a deprecated alias for the builtin `int`. To silence this warning, use `int` by itself. Doing this will not modify any behavior and is safe. When replacing `np.int`, you may wish to use e.g. `np.int64` or `np.int32` to specify the precision. If you wish to review your current use, check the release note link for additional information.
  Deprecated in NumPy 1.20; for more details and guidance: https://numpy.org/devdocs/release/1.20.0-notes.html#deprecations
    s = np.int(win_size/2)
  /tmp/ipykernel_13595/1019137027.py:489: FutureWarning: The frame.append method is deprecated and will be removed from pandas in a future version. Use pandas.concat instead.
    ds['tilt_x'] = (('time'), tdf.iloc[:s][::-1].append(tdf).append(tdf.iloc[-s:][::-1]).rolling(win_size, win_type='boxcar',     center=True).mean()[s:-s].values.flatten())
  /tmp/ipykernel_13595/1019137027.py:489: FutureWarning: The frame.append method is deprecated and will be removed from pandas in a future version. Use pandas.concat instead.
    ds['tilt_x'] = (('time'), tdf.iloc[:s][::-1].append(tdf).append(tdf.iloc[-s:][::-1]).rolling(win_size, win_type='boxcar',     center=True).mean()[s:-s].values.flatten())
  /tmp/ipykernel_13595/1019137027.py:491: FutureWarning: The frame.append method is deprecated and will be removed from pandas in a future version. Use pandas.concat instead.
    ds['tilt_y'] = (('time'), tdf.iloc[:s][::-1].append(tdf).append(tdf.iloc[-s:][::-1]).rolling(win_size, win_type='boxcar',    center=True).mean()[s:-s].values.flatten())
  /tmp/ipykernel_13595/1019137027.py:491: FutureWarning: The frame.append method is deprecated and will be removed from pandas in a future version. Use pandas.concat instead.
    ds['tilt_y'] = (('time'), tdf.iloc[:s][::-1].append(tdf).append(tdf.iloc[-s:][::-1]).rolling(win_size, win_type='boxcar',    center=True).mean()[s:-s].values.flatten())
  ...
  /tmp/ipykernel_13595/1019137027.py:491: FutureWarning: The frame.append method is deprecated and will be removed from pandas in a future version. Use pandas.concat instead.
    ds['tilt_y'] = (('time'), tdf.iloc[:s][::-1].append(tdf).append(tdf.iloc[-s:][::-1]).rolling(win_size, win_type='boxcar',    center=True).mean()[s:-s].values.flatten())
  /tmp/ipykernel_13595/1019137027.py:586: RuntimeWarning: divide by zero encountered in true_divide
  ...
  /tmp/ipykernel_13595/1019137027.py:491: FutureWarning: The frame.append method is deprecated and will be removed from pandas in a future version. Use pandas.concat instead.
    ds['tilt_y'] = (('time'), tdf.iloc[:s][::-1].append(tdf).append(tdf.iloc[-s:][::-1]).rolling(win_size, win_type='boxcar',    center=True).mean()[s:-s].values.flatten())
  /tmp/ipykernel_13595/1019137027.py:586: RuntimeWarning: invalid value encountered in true_divide
    phi_sensor_rad = -np.pi/2-np.arctan(Y/X) # spherical coordinate
  ...
  /tmp/ipykernel_13595/1019137027.py:741: DeprecationWarning: `np.float` is a deprecated alias for the builtin `float`. To silence this warning, use `float` by itself. Doing this will not modify any behavior and is safe. If you specifically wanted the numpy scalar type, use `np.float64` here.
  Deprecated in NumPy 1.20; for more details and guidance: https://numpy.org/devdocs/release/1.20.0-notes.html#deprecations
    if isinstance(df[c][v], np.float) and np.isnan(df[c][v]): continue
  /tmp/ipykernel_13595/1019137027.py:838: DeprecationWarning: `np.int` is a deprecated alias for the builtin `int`. To silence this warning, use `int` by itself. Doing this will not modify any behavior and is safe. When replacing `np.int`, you may wish to use e.g. `np.int64` or `np.int32` to specify the precision. If you wish to review your current use, check the release note link for additional information.
  Deprecated in NumPy 1.20; for more details and guidance: https://numpy.org/devdocs/release/1.20.0-notes.html#deprecations
    s = np.int(win_size/2)
  /tmp/ipykernel_13595/1019137027.py:840: FutureWarning: The frame.append method is deprecated and will be removed from pandas in a future version. Use pandas.concat instead.
    ds['tilt_x'] = (('time'), tdf.iloc[:s][::-1].append(tdf).append(tdf.iloc[-s:][::-1]).rolling(win_size, win_type='boxcar',     center=True).mean()[s:-s].values.flatten())
  /tmp/ipykernel_13595/1019137027.py:840: FutureWarning: The frame.append method is deprecated and will be removed from pandas in a future version. Use pandas.concat instead.
    ds['tilt_x'] = (('time'), tdf.iloc[:s][::-1].append(tdf).append(tdf.iloc[-s:][::-1]).rolling(win_size, win_type='boxcar',     center=True).mean()[s:-s].values.flatten())
  /tmp/ipykernel_13595/1019137027.py:842: FutureWarning: The frame.append method is deprecated and will be removed from pandas in a future version. Use pandas.concat instead.
    ds['tilt_y'] = (('time'), tdf.iloc[:s][::-1].append(tdf).append(tdf.iloc[-s:][::-1]).rolling(win_size, win_type='boxcar',    center=True).mean()[s:-s].values.flatten())
  /tmp/ipykernel_13595/1019137027.py:842: FutureWarning: The frame.append method is deprecated and will be removed from pandas in a future version. Use pandas.concat instead.
    ds['tilt_y'] = (('time'), tdf.iloc[:s][::-1].append(tdf).append(tdf.iloc[-s:][::-1]).rolling(win_size, win_type='boxcar',    center=True).mean()[s:-s].values.flatten())
...
#<<removing_spikes>> This is too agressive and is not used anymore
<<adding_columns>>
...
****** Radiation 
 ...
 #    ds['usr'] = ds['usr'].where(ds['usr'] != -9999.)
     ds = ds[['dsr','usr','dsr_corr','usr_corr','dlr','ulr','albedo','cloud_cov', 't_surf']].to_dataframe()
 ...
 #+RESULTS:
 [[file:./.ob-jupyter/bb7b0ecbd133b7c01c1423136d88890ef5120331.png]]
...
****** Radiation
 ...
 #+RESULTS:
 :RESULTS:
 [[file:./.ob-jupyter/e8a809e98bd4daa9e31117982880be29d5de5fcc.png]]
 [[file:./.ob-jupyter/0426a4ca6985b9191650f4664d50528968ace514.png]]
 :END:
...
#+BEGIN_SRC jupyter-python
 ...
 lowering[lowering>0.5] = np.nan
 lowering.plot()
 lowering.to_csv('data_v1.0/gem_database/2022/preQC/zac_u_lowering.csv', index = True, float_format = '%g')
 #+END_SRC

 #+RESULTS:
 [[file:./.ob-jupyter/23844c1a8f7ba10137ca050bd63da891430ca163.png]]
...
****** albedo
 ...
 with xr.open_dataset(zac_u_path) as ds:
     df = ds[['albedo']].to_dataframe()

 count10min = df.resample('H').count()
 a_hour = df.resample('H').median()
 a_hour[count10min<6] = np.nan
 count_hours = a_hour.resample('D').count()
 count_hours.plot()
 count10min.plot()
 a_day = a_hour.resample('D').median()
 a_day[count_hours<24 ] = np.nan

 a_day.plot()
 a_hour.plot()

 a_hour.to_csv('data_v1.0/gem_database/2022/preQC/zac_u_hour_albedo.csv', index = True, float_format = '%g')
 a_day.to_csv('data_v1.0/gem_database/2022/preQC/zac_u_day_albedo.csv', index = True, float_format = '%g')
    
 #+END_SRC

 #+RESULTS:
 :RESULTS:
 [[file:./.ob-jupyter/799675bd69861da4293ecf9f98f1676b700e5b53.png]]
 [[file:./.ob-jupyter/4242ed6c92d3f213e2906e4739c89508af384085.png]]
 [[file:./.ob-jupyter/475c664af4df8610934983728072555694814f2d.png]]
 [[file:./.ob-jupyter/7b6c5e594b91b3ee6ed0b3dd9e2e1af685989ea3.png]]
 :END:
...
****** cloudcover
 ...
 with xr.open_dataset(zac_u_path) as ds:
     df = ds[['cloud_cov']].to_dataframe()

 count10min = df.resample('H').count()
 clouds_hour = df.resample('H').median()
 clouds_hour[count10min<6] = np.nan
 count_hours = clouds_hour.resample('D').count()
 count_hours.plot()
 count10min.plot()
 clouds_day = clouds_hour.resample('D').median()
 clouds_day[count_hours<24 ] = np.nan

 clouds_day.plot()
 clouds_hour.plot()

 clouds_hour.to_csv('data_v1.0/gem_database/2022/preQC/zac_u_hour_cloud_cover.csv', index = True, float_format = '%g')
 clouds_day.to_csv('data_v1.0/gem_database/2022/preQC/zac_u_day_cloud_cover.csv', index = True, float_format = '%g')
    
 #+END_SRC

 #+RESULTS:
 :RESULTS:
 [[file:./.ob-jupyter/7967ca1a2822ea64122df5a848d6afd0b8264bf3.png]]
 [[file:./.ob-jupyter/a9899350c90f9112985310eb06183ecdfe13e7c8.png]]
 [[file:./.ob-jupyter/ac7d50e48c7923b4d21b5d3eb86e0cca6cb3f23b.png]]
 [[file:./.ob-jupyter/d06bcd1218f6423d5b25e6b111015c3b1eb9e06c.png]]
 :END:
...
****** Radiation
 ...
 #+RESULTS:
 :RESULTS:
 [[file:./.ob-jupyter/b9ff31e439234fc06e999e6e30d63e6c9ba173b3.png]]
 [[file:./.ob-jupyter/ea815afbe5cf3b958ebdfe31de7b46d1383e40c4.png]]
 :END:
...
#+BEGIN_SRC jupyter-python
 ...
 #+RESULTS:
 [[file:./.ob-jupyter/777bee6bb17948d98b1c440d429f403da0389d2b.png]]
...
****** zac_l
  ...
  z_l.loc[:'2008-July-1'] = np.nan
  z_l.loc['2008'] = z_l.loc['2008']-z_l.loc['2008-July-2'].mean()
  z_l.loc['2009-10-1'] = np.nan
  z_l.loc['2009'] = z_l.loc['2009']-z_l.loc['2009-June-26'].mean()
  z_l.loc['2009-5-14':'2009-6-24']= np.nan

  z_l.loc['2010-1-1':'2010-5-15'] = np.nan
  z_l.loc['2010'] = z_l.loc['2010']-z_l.loc['2010-5-16'].mean()
  z_l.loc['2010-8-2':'2010-12-31'] = np.nan

  z_l.loc['2011-1-1':'2011-5-7'] = np.nan
  z_l.loc['2011'] = z_l.loc['2011']-z_l.loc['2011-5-8'].mean()
  z_l.loc['2012-1-1':'2012-4-18'] = np.nan
  z_l.loc['2012'] = z_l.loc['2012']-z_l.loc['2012-4-19'].mean() 
  z_l.loc['2013'] = z_l.loc['2013']-z_l.loc['2013-4-1':'2013-5-1'].mean()
  z_l.loc['2014'] = z_l.loc['2014']-z_l.loc['2014-5-1':'2014-6-1'].mean()
  z_l.loc['2015-1-1':'2015-6-2'] = np.nan
  z_l.loc['2015'] = z_l.loc['2015']-z_l.loc['2015-6-3':'2015-6-15'].mean() 
  z_l.loc['2015-12-1':'2015-12-31'] = np.nan
  z_l.loc['2016-1-1':'2016-5-1'] = np.nan
  z_l.loc['2016'] = z_l.loc['2016']-z_l.loc['2016-5-2':'2016-5-15'].mean()
  z_l.loc['2017-1-1':'2017-5-1'] = np.nan
  z_l.loc['2017'] = z_l.loc['2017']-z_l.loc['2017-5-2':'2017-5-15'].mean()
  z_l.loc['2018-1-1':'2018-5-1'] = np.nan
  z_l.loc['2018'] = z_l.loc['2018']-z_l.loc['2018-5-2':'2018-5-15'].mean() 
  z_l.loc['2019'] = np.nan
  z_l.loc['2020'] = z_l.loc['2020']-z_l.loc['2020-5-2':'2020-5-15'].mean()

  z_l.loc['2021'] = z_l.loc['2021']-z_l.loc['2021-5-2':'2021-5-15'].mean()
  z_l.loc['2021-9-1':'2022-5-1'] = np.nan
...
z_l.loc['2008'] = z_l.loc['2008']-z_l.loc['2008-July-2'].mean()
#z_l.loc['2009-10-1'] = np.nan
z_l.loc['2009'] = z_l.loc['2009']-z_l.loc['2009-July-2'].mean()
#z_l.loc['2009-5-14':'2009-6-24']= np.nan

#z_l.loc['2010-1-1':'2010-5-15'] = np.nan
z_l.loc['2010'] = z_l.loc['2010']-z_l.loc['2010-5-15'].mean()
#z_l.loc['2010-8-2':'2010-12-31'] = np.nan

#z_l.loc['2011-1-1':'2011-5-7'] = np.nan
z_l.loc['2011'] = z_l.loc['2011']-z_l.loc['2011-6-20'].mean()
#z_l.loc['2012-1-1':'2012-4-18'] = np.nan
z_l.loc['2012'] = z_l.loc['2012']-z_l.loc['2012-6-27'].mean() 
z_l.loc['2013'] = z_l.loc['2013']-z_l.loc['2013-6-5'].mean()
z_l.loc['2014'] = z_l.loc['2014']-z_l.loc['2014-7-8'].mean()
#z_l.loc['2015-1-1':'2015-6-2'] = np.nan
z_l.loc['2015'] = z_l.loc['2015']-z_l.loc['2015-7-3'].mean() 
#z_l.loc['2015-12-1':'2015-12-31'] = np.nan
#z_l.loc['2016-1-1':'2016-5-1'] = np.nan
z_l.loc['2016'] = z_l.loc['2016']-z_l.loc['2016-6-23'].mean()
#z_l.loc['2017-1-1':'2017-5-1'] = np.nan
z_l.loc['2017'] = z_l.loc['2017']-z_l.loc['2017-6-27'].mean()
#z_l.loc['2018-1-1':'2018-5-1'] = np.nan
z_l.loc['2018'] = z_l.loc['2018']-z_l.loc['2018-7-30'].mean() 
#z_l.loc['2019'] = np.nan
z_l.loc['2019'] = z_l.loc['2019']-z_l.loc['2019-6-12'].mean()
...
#+RESULTS:
[[file:./.ob-jupyter/f1b353a7b03f973896fc9c4b3309822ab9fbcc3e.png]]
...
#+RESULTS:
:RESULTS:
[[file:./.ob-jupyter/086f4b6bdc693f7ac3e44606aa259f393ad5c4af.png]]
[[file:./.ob-jupyter/0781e2eed111a21eef5d73ff993905b77854537b.png]]
:END:
...
zac_u[variable].plot(ax = ax[0], label = 'zac_u', color = 'tab:orange')
zac_a[variable].plot(ax = ax[0], label = 'zac_a', color = 'tab:pink')
ax[0].legend()
ax[0].set_title('Final dataset')
...
d_l_u_pre[variable].plot(ax=ax[1], label = 'Flagged in QC', color = 'tab:red')
d_u_a_pre[variable].plot(ax=ax[2], label = 'Flagged in QC', color = 'tab:red')
d_l_a_pre[variable].plot(ax=ax[3], label = 'Flagged in QC', color = 'tab:red')

d_l_u[variable].plot(ax=ax[1], label = 'zac_l minus zac_u', color = 'tab:green')
d_u_a[variable].plot(ax=ax[2], label = 'zac_u minus zac_a', color = 'tab:green')
d_l_a[variable].plot(ax=ax[3], label = 'zac_l minus zac_a', color = 'tab:green')
ax[1].set_title('Gradients')
ax[1].legend()
ax[1].set_ylabel(ylabel + '/100m')
ax[2].legend()
ax[2].set_ylabel(ylabel + '/100m')
ax[3].legend()
ax[3].set_ylabel(ylabel + '/100m')

#+END_SRC

#+RESULTS: plot_gradients_full_period
:RESULTS:
: <matplotlib.legend.Legend at 0x7f941cd4c4f0>
[[file:./.ob-jupyter/92d3bd31c508f968fb45ea29c8d42f687ecc4315.png]]
:END:
...
[[file:./.ob-jupyter/87af0dcf87b11ffd8bfffd067302685d2e345b93.png]]
:END:
...
******* Calculating the sun parameters
    ...
    for i in {1..365..1}
    do
    r.sun elevation=demNE linke_value=1.5 distance_step=1.5 horizon_basename=horangle horizon_step=1  aspect=aspect.dem slope=slope.dem albedo_value=0.2 day=$i glob_rad=glob$i insol_time=it$i nproc=4 --overwrite
    done
    #+END_SRC
...
dsr_corr_sum = pd.DataFrame(zac_l['dsr_corr'].resample('D').sum())
usr_corr_sum = pd.DataFrame(zac_l['usr_corr'].resample('D').sum())
...
for year in np.arange(2008,2021):
    ...
    ax.plot(dsr_corr_sum.loc[str(year)].index.dayofyear,dsr_corr_sum.loc[str(year)], label = 'dsr_corr - '+str(year))
...
#+RESULTS:
:RESULTS:
[[file:./.ob-jupyter/7c381e2346c80efb66034828c9b37674860058b3.png]]
[[file:./.ob-jupyter/7bd85b53d6d1f01cce0542565e9c1b45f48dc459.png]]
[[file:./.ob-jupyter/47a87cc618c8bb7fbdb5b208e1eb4b4a2d84d512.png]]
[[file:./.ob-jupyter/2142d933cfba0cbac6581224b662e34ca146b8e5.png]]
[[file:./.ob-jupyter/53be3a82fd209f3e26e42e4ee61cc9ecb16ae4aa.png]]
[[file:./.ob-jupyter/ccf0260d60bf9b648348d25645adbcf8052f0b74.png]]
[[file:./.ob-jupyter/18c945454e62489548f046e8084036e6d2cfd3f8.png]]
[[file:./.ob-jupyter/76af443616c87371c13fdaabb52407245d77674c.png]]
[[file:./.ob-jupyter/746c18c85ba181c553237796e1d2af595ce4a3eb.png]]
[[file:./.ob-jupyter/f656b1a45fffbc3a200d3048b1528bf4af9a66b3.png]]
[[file:./.ob-jupyter/b8b4213aa3d98c601420f7de2bb285123b1d4ec3.png]]
[[file:./.ob-jupyter/dd7f68e5675fc6c28e47afcd039998e7dac2cf76.png]]
[[file:./.ob-jupyter/a6c1ba869ca5b2841e28c1cfac760edddb872841.png]]
:END:
...
boom_l.plot(ax=ax[0])
boom_l.rolling(24,center=True).median().plot(ax = ax[0])
boom_u.plot(ax=ax[1])
...
# image/png
[[file:obipy-resources/9e526126f6e919503e0f2bfb2c43391732b7318e/03dc603ab64affef53827a4c370c94b37507eb1d.png]]
:end:
...
ablation = pd.read_csv(workingfolder+'preQC/' + site + '_hour_ice_ablation.csv', index_col = 0)

merged = temp.join(rh, how='outer').join(p, how='outer').join(rad, how='outer').join(ws, how='outer').join(height, how='outer').join(surf, how='outer')

merged.rename(columns = {'t_1':'T_air', 'rh': 'RH', 'p': 'P_air', 'dsr':'SR_in', 'usr':'SR_out','dsr_corr':'SR_in_corr', 'usr_corr':'SR_out_corr', 'dlr':'LR_in', 'ulr':'LR_out','cloud_cov':'cloudcover','t_surf':'T_surf', 'wspd':'WS', 'z_boom':'H', 'z_pt_corr':'Ablation' }, inplace = True)
...
#+begin_example
  ...
  ...                         ...          ...      ...      ...       ...   
  2022-04-19 07:00:00     99.7908      79.7940  250.738  250.335       NaN   
  2022-04-19 08:00:00    175.9790     136.1550  254.152  256.830       NaN   
  ...
  2022-04-19 11:00:00    329.7010     263.9390  256.040  269.540  0.801010   
                       ...
                       cloudcover   T_surf        WS        H  Ablation  
  time                                                                   
  2008-03-29 16:00:00    0.125282 -21.9616  4.543500  2.66900       NaN  
  2008-03-29 17:00:00    0.112939 -22.1859  4.715000  2.67291       NaN  
  2008-03-29 18:00:00    0.127969 -23.3492  2.866330  2.66831       NaN  
  2008-03-29 19:00:00    0.116779 -23.9642  2.806330  2.67440       NaN  
  2008-03-29 20:00:00    0.117033 -22.8161  5.395000  2.67063       NaN  
  ...                         ...      ...       ...      ...       ...  
  2022-04-19 07:00:00    0.993019 -15.3841  0.857667  2.07494       NaN  
  2022-04-19 08:00:00    0.957921 -13.7031  1.421830  2.07687       NaN  
  2022-04-19 09:00:00    0.837836 -12.9951  0.820333  2.08100       NaN  
  2022-04-19 10:00:00    0.773889 -14.0433  0.940333  2.07443       NaN  
  2022-04-19 11:00:00    0.899866 -10.4726  2.136500  2.07567       NaN  

  [123212 rows x 15 columns]
#+end_example
[[file:./.ob-jupyter/3cd3643c2faf1dbb39d632e21d98f2c923a58c21.png]]
:END:
...
merged.rename(columns = {'t_1':'T_air', 'rh': 'RH', 'p': 'P_air', 'dsr':'SR_in', 'usr':'SR_out','dsr_corr':'SR_in_corr', 'usr_corr':'SR_out_corr', 'dlr':'LR_in', 'ulr':'LR_out','cloud_cov':'cloudcover','t_surf':'T_surf', 'wspd':'WS', 'z_boom':'H', 'z_pt_corr':'Z_pt' }, inplace = True)
#merged.plot(subplots = True, figsize = (12,12))

cols = ['T_air', 'RH', 'P_air', 'SR_in', 'SR_out', 'LR_in','LR_out', 'WS', 'H', 'Z_pt']
<<drop_head_and_tail_nans_fast>>
merged_slim = drop_nan_rows(merged)
...
#+begin_example
  ...
  2022-04-19 14:00:00      357.564  231.321  280.398  0.798091    0.505859   
                         ...
                         T_surf       WS        H  Z_pt  
  time                                                   
  2008-03-29 18:00:00       NaN  3.06183      NaN   NaN  
  2008-03-29 19:00:00       NaN  1.73083      NaN   NaN  
  2008-03-29 20:00:00       NaN  2.68367      NaN   NaN  
  2008-03-29 21:00:00       NaN  3.08867      NaN   NaN  
  2008-03-29 22:00:00       NaN  4.31950      NaN   NaN  
  ...                       ...      ...      ...   ...  
  2022-04-19 10:00:00 -11.65090      NaN  2.17570   NaN  
  2022-04-19 11:00:00 -11.33500      NaN  2.17573   NaN  
  2022-04-19 12:00:00  -9.48939      NaN  2.17417   NaN  
  2022-04-19 13:00:00  -7.75355      NaN  2.17322   NaN  
  2022-04-19 14:00:00  -7.63614      NaN  2.17596   NaN  

  [123213 rows x 15 columns]
#+end_example
...
#+begin_example
  ...
  2019-04-13 08:00:00   208.95600   207.027000  258.101  279.943       NaN   
  2019-04-13 09:00:00   312.81000   303.702000  264.028  281.681       NaN   
  ...
  2019-04-13 11:00:00   561.34200   495.338000  251.199  283.532  0.885045   
                       ...
                       cloudcover    T_surf       WS        H  
  time                                                         
  2009-05-15 20:00:00    0.869447  16.07180  0.00000      NaN  
  2009-05-15 21:00:00         NaN       NaN      NaN      NaN  
  2009-05-15 22:00:00         NaN       NaN      NaN      NaN  
  2009-05-15 23:00:00         NaN       NaN      NaN      NaN  
  2009-05-16 00:00:00         NaN       NaN      NaN      NaN  
  ...                         ...       ...      ...      ...  
  2019-04-13 07:00:00    0.427362 -10.97330  6.06417  2.18327  
  2019-04-13 08:00:00    0.466625  -7.91416  8.00800  2.19128  
  2019-04-13 09:00:00    0.517423  -7.53442  6.28483  2.19484  
  2019-04-13 10:00:00    0.503184  -7.51478  4.95967  2.19339  
  2019-04-13 11:00:00    0.375824  -6.99982  4.48017  2.19040  

  [86872 rows x 14 columns]
#+end_example
[[file:./.ob-jupyter/66b5899539ab04e554fa137b622e79600169e7ed.png]]
:END:
